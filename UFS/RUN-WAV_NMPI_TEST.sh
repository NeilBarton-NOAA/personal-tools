...
####################################
# Set Top options
export TEST_NAME=WAV_TIMING_${WAV_RES} #TEST_WARM_S2SW #_${WAV_RES}
#export WAV_RES=mx025gefs # 'mx025gefs tripolar a b'
export DTG=2013041500 #2019120300  # 2013041500 # if no DTG, defaults to RT
export TOP_ICDIR=${NPB_WORKDIR}/ICs/${DTG}
export ATM_ICDIR=${TOP_ICDIR}
export OCN_ICDIR=${TOP_ICDIR}
export ICE_ICDIR=${TOP_ICDIR}
...
RUNDIR="${NPB_WORKDIR}/RUNS/WAV_TIMINGS/${TEST_NAME}_${DTG}"
